...
let ItemsService = class ItemsService {
    ...
    createItem(type, body) {
        return this.itemsRepository.save(Object.assign(Object.assign({}, body), { type_name: type }));
    }
    deleteItemByName(params) {
        return this.itemsRepository.delete({ name: params.item, type_name: params.type });
    }
    async getItemByName(params) {
        let re;
        console.log();
        if ((re = await this.itemsRepository.find({
    ...
    async updateItemBYName(params, body) {
        console.log(params);
        console.log(body);
        let re;
