...
const ptype_entity_1 = require("./entity/ptype.entity");
let TypesService = class TypesService {
    constructor(typeRepository) {
        this.typeRepository = typeRepository;
    }
    async getAllFromTypeByName(name) {
    ...
    async deleteTypeByName(name) {
        const re = await this.typeRepository.delete(name);
        return re;
    }
    async updateTypeName(name, body) {
...
TypesService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(ptype_entity_1.Type)),
